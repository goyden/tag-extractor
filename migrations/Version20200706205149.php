 ...
 */
final class Version20200706205149 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE analysis (id INT NOT NULL, url TEXT NOT NULL, is_finished BOOLEAN DEFAULT \'false\' NOT NULL, is_failed BOOLEAN DEFAULT \'false\' NOT NULL, PRIMARY KEY(id))');
